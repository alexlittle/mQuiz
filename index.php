...
<div id="start1" class="homestart">
	...
	<a href="quiz/new.php" title="Create your quiz now..."><img
		src="images/mquiz-create.png" /> </a>
...
<div id="start2" class="homestart">
	...
	<iframe width="220" height="165"
		src="http://www.youtube.com/embed/6WmWoTkQvZw" frameborder="0"
		allowfullscreen></iframe>
</div>

<div id="start3" class="homestart">
	<h3>3. View and track results</h3>
	<a href="quiz/view.php?ref=qtAlex4ecb84e858a86&view=question"><img
		src="images/mquiz-results.png" /> </a>
</div>
...
<div style="clear: both;">
	<div id="top10quizzes" class="homewidget">
		...
		foreach ($top10popular as $t){
			echo "<li>";
			printf("<a href='./m/#%s'>%s</a>",$t->qref,$t->quiztitle);
			printf("<br/><small>(%d <a href='./quiz/view.php?ref=%s'>attempts</a>)</small>",$t->noattempts,$t->qref);
			echo "</li>";
		}
		?>
		</ol>
